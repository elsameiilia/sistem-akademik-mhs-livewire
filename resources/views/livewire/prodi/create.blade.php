<div>
    <div class="w-full max-w-2xl mx-auto bg-white shadow-lg rounded-xl p-6 md:p-8">
        ...
        <form wire:submit.prevent="store">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Tambah Prodi Baru</h2>
                <p class="text-gray-500 mt-1">Isi detail program studi pada form di bawah ini.</p>
            </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 flex items-center justify-end gap-3">
                ...
                <button type="submit" dusk="btn-submit-prodi"
